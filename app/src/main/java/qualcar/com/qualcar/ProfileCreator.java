...
public class ProfileCreator {
    ...
    public static ProfileModel populateNitish() {
        //person 1 Nitish
    ...
    public static ProfileModel populateHanna() {
        //person 2 Hanna
    ...
    public static ProfileModel populateRyan() {
        //person 3 Ryan
    ...
    public static ProfileModel populateEnrique() {
        //person 4 Enrique
    ...
    public static ProfileModel populateGreg() {
        //person 5 Greg
